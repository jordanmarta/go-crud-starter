...
import (
	...
	configuration "github.com/jordanmarta/go-crud-starter/src/configuration"
	model "github.com/jordanmarta/go-crud-starter/src/model"
)
...
func (m *MockUserRepository) CreateUser(userDomain model.UserDomainInterface) (model.UserDomainInterface, *configuration.RestErr) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", userDomain)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*configuration.RestErr)
	return ret0, ret1
}
...
func (m *MockUserRepository) DeleteUser(userId string) *configuration.RestErr {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUser", userId)
	ret0, _ := ret[0].(*configuration.RestErr)
	return ret0
}
...
func (m *MockUserRepository) FindUserByEmail(email string) (model.UserDomainInterface, *configuration.RestErr) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmailAndPassword(email, password string) (model.UserDomainInterface, *configuration.RestErr) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByID(email string) (model.UserDomainInterface, *configuration.RestErr) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindUserByID", email)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*configuration.RestErr)
	return ret0, ret1
}
...
func (mr *MockUserRepositoryMockRecorder) FindUserByID(email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindUserByID", reflect.TypeOf((*MockUserRepository)(nil).FindUserByID), email)
}

// UpdateUser mocks base method.
func (m *MockUserRepository) UpdateUser(userId string, userDomain model.UserDomainInterface) *configuration.RestErr {
	m.ctrl.T.Helper()
